					...
					<div class="col-lg-12">
						...
						<div class="wow fadeInRight animated" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.2s; animation-name: fadeInRight;">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-user-md"></span> Find Doctors</h3>
							</div>
								<div class="panel-body">
					                ...
					                <form id="admin_form" action="<?php echo site_url('find_doctors/submit');?>" method="post" role="form" class="contactForm lead">
									...
									<table class="table table-bordered table-hover table-striped" id="medical_services_table">
										<thead>
											<tr>
												<th colspan="7" class="text-center">Doctor Directory</th>
											</tr>
											<tr>
												<th>No.</th>
												<th>Doctor</th>
										...
										<?php if(empty($form_data['table_data'])):?>
											<td colspan="7" class="text-center">Sorry. We could not find any doctors.</td>
										</tbody>
										<?php else: 
