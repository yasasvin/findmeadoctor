					...
					<div class="col-lg-12">
						...
						<div class="wow fadeInRight animated" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.2s; animation-name: fadeInRight;">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Manage Symptoms</h3>
							</div>
								<div class="panel-body">
					                ...
					                <form id="admin_form" action="<?php echo site_url('symptoms/submit');?>" method="post" role="form" class="contactForm lead">
					                	<input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('symptoms_id', $form_data['symptoms_id']); ?>"/>
					                	<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Symptom Description</label>
													<input name="symptoms_description" id="symptoms_description" class="form-control input-md" type="text" value="<?php echo set_value('symptoms_description', $form_data['symptoms_description']); ?>" required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tr>
											...
											<td class="text-center"><strong><a class="text-info" href="<?php echo site_url('symptoms/index/') . $e['id']; ?>">Edit</a></strong></td>
										</tr>
										<?php endforeach;
										endif;?>
									</table>
