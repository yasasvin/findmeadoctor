					...
					<div class="col-lg-12">
						...
						<div class="wow fadeInRight animated" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.2s; animation-name: fadeInRight;">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Manage Medical Service Types</h3>
							</div>
								<div class="panel-body">
					                ...
					                <form id="admin_form" action="<?php echo site_url('service_types/submit');?>" method="post" role="form" class="contactForm lead">
					                	<input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('medical_service_type_id', $form_data['medical_service_type_id']); ?>"/>
					                	<div class="row">
									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tr>
											...
											<td class="text-center"><strong><a class="text-info" href="<?php echo site_url('service_types/index/') . $e['id']; ?>">Edit</a></strong></td>
										</tr>
										<?php endforeach;
										endif;?>
									</table>
