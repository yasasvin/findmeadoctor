					...
					<div class="col-lg-12">
						...
						<div class="wow fadeInRight animated" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.2s; animation-name: fadeInRight;">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Manage Doctor Sepcializations</h3>
							</div>
								<div class="panel-body">
					                ...
					                <form id="admin_form" action="<?php echo site_url('specializations/submit');?>" method="post" role="form" class="contactForm lead">
					                	<input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('update_id', $form_data['specialization_id']); ?>"/>
					                	<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Doctor Specialization</label>
													<input name="specialization_name" id="specialization_name" class="form-control input-md" type="text" value="<?php echo set_value('specialization_name', $form_data['specialization_name']); ?>" required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													...
													<select name="related_medical_conditions[]" id="related_medical_conditions" class="form-control" required multiple>
														<?php echo $form_data['related_medical_conditions'];?>
													</select>
												</div>
											</div>
										</div>
									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tr>
											...
											<td class="text-center"><strong><a class="text-info" href="<?php echo site_url('specializations/index/') . $e['id']; ?>">Edit</a></strong></td>
										</tr>
										<?php endforeach;
										endif;?>
									</table>
